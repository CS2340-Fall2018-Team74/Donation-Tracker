                ...
                addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (DocumentSnapshot locationSnapshot : task.getResult()) {
                                final Location location = locationSnapshot.toObject(Location.class);
                                locations.add(location);
                                Log.d("load", "location added");
//                                Query query = locationSnapshot.getReference().collection("Items");
//
//                                        get().
//                                            addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
//                                                @Override
...
//                                                            Log.d("load", "item added");
//                                                        }
//                                                    } else {
//                                                        Log.d("load", "item fail");
//                                                    }
//                                                }
//                                            });
                            }
        ...
        //set key for next new locations created in app
        Location.setLocationId(locations.size() + 1);
